...
public static class MeshyFlameHeirSetup
{
    ...
    const string ControllerPath = "Assets/Resources/Characters/FlameHeir/FlameHeir.controller";
    const string MaterialPath = "Assets/Resources/Characters/FlameHeir/FlameHeir_Material.mat";
    ...
    public static void Configure(bool verbose)
    {
        ...
        if (verbose)
            Debug.Log("Herdeiro das Chamas configurado: modelo, material e FlameHeir.controller atualizados.");
    }
    ...
    static void ConfigureAnimatorController(bool verbose)
    {
        ...
        {
            if (verbose)
                Debug.LogWarning($"Nao foi possivel criar o AnimatorController do Herdeiro das Chamas em {ControllerPath}.");
            return;
        }
    ...
    {
        AnimationClip idle = LoadClip("Animation_Idle_5", true);
        AnimationClip walk = LoadClip("Animation_Proud_Strut", true);
    ...
    static void ConfigureActionStates(AnimatorStateMachine stateMachine, AnimatorState locomotion)
    {
        ...
        {
            new ActionAnimation("FlameHit", PlayerAnimationBridge.LegacyChopTrigger, "Animation_Left_Jab_from_Guard", 0.82f, new Vector3(520f, -180f, 0f)),
            new ActionAnimation("FlameAttack", PlayerAnimationBridge.AttackTrigger, "Animation_Left_Jab_from_Guard", 0.82f, new Vector3(520f, -240f, 0f)),
            new ActionAnimation("FlameCut", PlayerAnimationBridge.CutWoodTrigger, "Animation_Right_Hand_Sword_Slash", 0.86f, new Vector3(520f, -300f, 0f)),
            new ActionAnimation("FlameMine", PlayerAnimationBridge.MineTrigger, "Animation_Right_Hand_Sword_Slash", 0.86f, new Vector3(520f, -360f, 0f)),
            new ActionAnimation("FlamePickup", PlayerAnimationBridge.PickupTrigger, "Animation_Male_Bend_Over_Pick_Up", 0.82f, new Vector3(520f, -420f, 0f)),
            new ActionAnimation("FlamePowerStoneWall", PlayerAnimationBridge.PowerStoneWallTrigger, "Animation_mage_soell_cast_2", 0.86f, new Vector3(820f, -180f, 0f)),
            new ActionAnimation("FlamePowerDive", PlayerAnimationBridge.PowerDiveTrigger, "Animation_Jump_Over_Obstacle_2", 0.9f, new Vector3(820f, -240f, 0f)),
            new ActionAnimation("FlamePowerQ", PlayerAnimationBridge.Power1Trigger, "Animation_mage_soell_cast_3", 0.86f, new Vector3(820f, -300f, 0f)),
            new ActionAnimation("FlamePowerR", PlayerAnimationBridge.Power2Trigger, "Animation_mage_soell_cast_2", 0.86f, new Vector3(820f, -360f, 0f)),
            new ActionAnimation("FlamePowerF", PlayerAnimationBridge.Power3Trigger, "Animation_Charged_Spell_Cast", 0.88f, new Vector3(820f, -420f, 0f)),
            new ActionAnimation("FlameVictory", PlayerAnimationBridge.VictoryTrigger, "Animation_Squat_Stance", 0.88f, new Vector3(1120f, -180f, 0f)),
            new ActionAnimation("FlameDie", PlayerAnimationBridge.DieTrigger, "Animation_Fall_Dead_from_Abdominal_Injury", 0.96f, new Vector3(1120f, -240f, 0f)),
            new ActionAnimation("FlameJump", PlayerAnimationBridge.JumpTrigger, "Animation_Jump_Over_Obstacle_2", 0.9f, new Vector3(1120f, -300f, 0f)),
            new ActionAnimation("FlameRunJump", PlayerAnimationBridge.RunJumpTrigger, "Animation_Jump_Over_Obstacle_2", 0.9f, new Vector3(1120f, -360f, 0f)),
            new ActionAnimation("FlameFall", PlayerAnimationBridge.FallTrigger, "Animation_Jump_Over_Obstacle_2", 0.82f, new Vector3(1120f, -420f, 0f))
        };
...
public class MeshyFlameHeirAssetPostprocessor : AssetPostprocessor
{
    ...
    static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
    {
        if (ContainsFlameHeirAsset(importedAssets) || ContainsFlameHeirAsset(movedAssets))
            MeshyFlameHeirSetup.ScheduleAutoSetup();
    }

    static bool ContainsFlameHeirAsset(string[] paths)
    {
        if (paths == null)
            return false;
    ...
    const string RootPath = "Assets/Resources/Characters/FlameHeir";
}
